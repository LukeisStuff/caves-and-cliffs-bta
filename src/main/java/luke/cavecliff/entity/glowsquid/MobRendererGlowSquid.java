...
public class MobRendererGlowSquid extends MobRenderer<MobGlowSquid> {
	...
	public boolean setGlowSquidBrightness(MobGlowSquid glowsquid, int renderPass, float partialTick) {
		if (renderPass == 0) {
	...
	public boolean prepareArmor(MobGlowSquid entity, int renderPass, float partialTick) {
		return this.setGlowSquidBrightness(entity, renderPass, partialTick);
	}
