...
public class ParticleFloatingSpore extends ParticleLeaf {
    public ParticleFloatingSpore(World world, double x, double y, double z, double d3, double d4, double d5) {
    ...
    @Override
    public ParticleFloatingSpore init(int x, int y, int z) {
