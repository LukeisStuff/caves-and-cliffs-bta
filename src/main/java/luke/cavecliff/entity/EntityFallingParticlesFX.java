...
//
//public class EntityFallingParticlesFX extends ParticleLeaf {
//	public EntityFallingParticlesFX(World world, double x, double y, double z, double d3, double d4, double d5) {
...
//	}
//
//    public EntityFallingParticlesFX func_4041_a(int i, int j, int k) {
