...
public class BlockModelAmethystCluster<T extends Block> extends BlockModelStandard<T> {
	public final IconCoordinate[] growthStageTextures = new IconCoordinate[]{
		TextureRegistry.getTexture(MOD_ID + ":block/amethyst_small"),
		TextureRegistry.getTexture(MOD_ID + ":block/amethyst_medium"),
		TextureRegistry.getTexture(MOD_ID + ":block/amethyst_large"),
		TextureRegistry.getTexture(MOD_ID + ":block/amethyst_cluster")
	};

	public BlockModelAmethystCluster(Block block) {
		super(block);
	}
